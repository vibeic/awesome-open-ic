...
Courses, free books, and self-study tracks for digital, analog, and VLSI.

## Courses

- **[Stanford EE271](https://web.stanford.edu/class/ee271/)** — Introduction to VLSI Systems. Foundational VLSI design course.
  `License: Open courseware` | `Last commit: 2024` | ![MCP](https://img.shields.io/badge/MCP-no-lightgrey) *N/A — course*
- **[ZeroToASIC course](https://zerotoasiccourse.com/)** — Matt Venn's hands-on course taking your RTL all the way to a Caravel chip on sky130.
  `License: Paid course, open materials` | `Last commit: 2025` | ![MCP](https://img.shields.io/badge/MCP-no-lightgrey) *N/A — course*
- **[Harvard CS148 / CS141](https://www.eecs.harvard.edu/~htk/courses/)** — Harvard digital design course materials.
  `License: Open courseware` | `Last commit: 2024` | ![MCP](https://img.shields.io/badge/MCP-no-lightgrey) *N/A — course*
- **[CMU 18-447 Computer Architecture](https://course.ece.cmu.edu/~ece447/)** — Onur Mutlu's classic CMU computer-architecture course, freely available lectures + slides.
  `License: Open courseware` | `Last commit: 2023` | ![MCP](https://img.shields.io/badge/MCP-no-lightgrey) *N/A — course*
- **[UC Berkeley CS152](https://inst.eecs.berkeley.edu/~cs152/)** — Berkeley's computer-architecture course; covers RISC-V + Chisel labs.
  `License: Open courseware` | `Last commit: 2024` | ![MCP](https://img.shields.io/badge/MCP-no-lightgrey) *N/A — course*
...
- **[Logisim-evolution](https://github.com/logisim-evolution/logisim-evolution)** — Digital logic design tool and simulator for education, with circuit simulation and Verilog/VHDL export.
