...
This list catalogs the open-source tools, IP cores, PDKs, foundry programs, and learning resources that make end-to-end integrated-circuit design possible without proprietary lock-in. **1049 curated entries across 12 categories and 109 sub-sections** — every URL and license verified at the time of inclusion.
